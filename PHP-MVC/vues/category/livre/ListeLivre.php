    ...
    <!-- Titre de ma liste -->
        <div class="row mb-3">
            ...
            <div class="col-md-3 offset-md-6">
                <a href="index.php?uc=pret&action=list" class="btn btn-info" role="button">Pret</a>
                <a href="index.php?uc=livre&action=add" class="btn btn-success" role="button">Nouveau Livre</a>
            </div>
        </div>
    <!-- End -->
